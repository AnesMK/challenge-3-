...
function employee(name, salary) {
    ...
    obj.increseSalary = increseSalary;
    return obj;
}
...
var addFriend = function (employee) {
    if (employeeA.friends === 'undefined') {
        employeeA.friends = employee.name;
    } else {
        employeeA.friends = employeeA.friends + ' ' + 'and ' employee.name;    
    }
    return 'you just became friend with ' + employeeA.friends;
}
...
function Pet (name) {
    ...
    obj.name = name;
    obj.addInfo = addInfo;
    obj.updateAge = updateAge;
    obj.availability = false;
    obj.isItAvailable = isItAvailable;
